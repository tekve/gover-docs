...
Yhdistä kontrollit vaatimuksiin:

- Merkitse soveltuvat kontrollit
- Dokumentoi perustelut poissulkemisille
- Linkitä implementoituihin kontrolleihin

### 5. Ota kontrollit käyttöön

Jokaiselle Liite A:n kontrollille:

1. Luo tai yhdistä olemassa olevat kontrollit
...
3. **Kontrollien implementointi** — Korjaa puutteet
...
| **Soveltuvuuslausunto (SoA)**     | Kontrollien soveltuvuus     |
...
- [Kontrollit](../user-guide/controls/overview) — Hallitse kontrollejasi
