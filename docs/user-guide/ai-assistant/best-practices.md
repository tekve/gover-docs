...
✅ "What controls should I implement for GDPR Article 32 security requirements?"

### Provide Context

❌ "Suggest mappings"
✅ "Suggest controls for the ISO 27001 A.9 Access Control requirements"
...
|------------|------------|
| May miss context | Provide more details |
| Can be wrong | Always verify suggestions |
| Doesn't know your org | Review against your reality |
| Generic advice | Customize for your needs |
...
- [AI Overview](./overview) — Return to overview
- [Chat Interface](./chat) — Start using the chat
