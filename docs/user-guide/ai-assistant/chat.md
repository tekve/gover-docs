...
Have conversations with Gover's AI to get help with compliance tasks.

## Opening the Chat

Click the **AI Assistant** icon in the sidebar to open the chat panel.
...
AI: I found 12 requirements without mapped controls:
- A.5.1.1 - Policies for information security
- A.5.1.2 - Review of policies
...
Would you like me to suggest controls for these?
```
...
2. **Provide context** — Mention the framework or area
